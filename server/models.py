...
class EmployeeDepartment(db.Model):
    ...
    employee = db.relationship('Employee', backref=db.backref('employee_departments', lazy=True))
    department = db.relationship('Department', backref=db.backref('employee_departments', lazy=True))
